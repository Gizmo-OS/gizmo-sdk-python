...
class ApplicationsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ApplicationsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/gizmo-sdk-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ApplicationsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/gizmo-sdk-python#with_streaming_response
        """
